          ...
          <div class="">
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <div class="count" id="artJoinNum">179</div>
                  <h3>예술전공생</h3>
                  <p>New Art Sign ups</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-comments-o"></i></div>
                  <div class="count" id="spaceJoinNum">179</div>
                  <h3>공간전공생</h3>
                  <p>New Space Sign ups</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>최근 회원가입 유저수<small>Weekly progress</small></h2>
                    <div class="filter">
...
<!-- 			
 ...
 -->
    ...
    <!-- Chart.js -->
    <script src="/resources/admin/vendors/Chart.js/dist/Chart.min.js"></script>
    <!-- jQuery Sparklines -->
    <script src="/resources/admin/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <!-- Flot -->
    ...
    <!-- Flot plugins -->
    <script src="/resources/admin/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="/resources/admin/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="/resources/admin/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
...
function init_flot_chart() {
    ...
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [
                ...
                [15, 4],
                [16, 9]
            ], f = 0; f < joinStatic.length; f++) d.push([new Date(joinStatic[f].joinDate), joinStatic[f].sumJoin]);
        var g = {
                series: {
                    lines: {
                        show: !1,
