...
<option value="1934">1934년</option>
                                ...
                                <tr>
                                    <th>주소(동까지)</th>
                                    <td>
                                        <select name="sidoCode" class="tBox joinBx tAddr" id="sidoCode" title="시, 도 선택">
                                        ...
                                        <select name="guCode" class="tBox joinBx tAddr" id="guCode" title="시, 군, 구 선택">
                                            <option value="">시·군·구</option>
                                        </select>
                                        <select name="dongCode" class="tBox joinBx tAddr" id="dongCode" title="동, 읍, 면 선택">
