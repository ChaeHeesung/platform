		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">Flight Offers</li>
					</ul>
				</div>
				<!-- end columns -->
			</div>
								...
								<div class="grid-block main-block f-grid-block">
									...
									<div class="block-info f-grid-info">
										<div class="f-grid-desc">
											<span class="f-grid-time"><i class="fa fa-clock-o"></i>6
											...
											<p>Lorem ipsum dolor sit amet, ad duo fugit aeque
												fabulas, in lucilius prodesset pri. Veniam delectus ei</p>
										</div>
										<!-- end f-grid-desc -->
			...
			<div class="row">
				<div class="col-sm-6 col-md-3">
					<div class="b-feature-block">
						...
						<p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in
							lucilius prodesset pri. Veniam delectus ei vis.</p>
					</div>
					<!-- end b-feature-block -->
				</div>
				<!-- end columns -->
